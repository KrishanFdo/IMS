...
<head>
    ...
    <title>Alumna | Send Emails</title>
   ...
   <div class="main-container d-flex">
    <div class="sidebar " id="side_nav">
        ...
        <ul class="list-unstyled px-2 ">
            ...
            <li class="active"><a href="/emailsend" class="text-decoration-none px-3 py-3 d-block">SEND EMAILS</a></li>
                        ...
                        <tbody>
                            <tr>
                               ...
                               <td>
                                ...
                                <br>
                                <input type="radio" id="role" name="role" value="BSC Special"/> BSC Special
                                <br/>
